! function(r) {
	...
	function n(r, t, e) {
		...
		var a = i.measureText(e.label).width,
			...
			d = l + u,
			h = .01;
		1 === e.mode ? r.addBlank(0, l - h, n, d + h) : r.addBlank(c - h, l - h, s + h, d + h), t.fillStyle = e
			.fontcolor, t.font = o, t.fillText(e.label, c * n, l * n + .75 * e.mSize * n)
	}
	...
	function o(r, t, e) {
		var n = e.size,
			...
			s = c + a,
			d = .01;
		3 === e.mode ? r.addBlank(0, c - d, n, s + d) : r.addBlank(f - d, c - d, l + d, s + d), t.drawImage(e.image, f *
			n, c * n, u * n, a * n)
	}

	function i(r, t, e) {
		w(e.background).is("img") ? t.drawImage(e.background, 0, 0, e.size, e.size) : e.background && (t.fillStyle = e
	...
	function c(r, t, e, n, o, i, a, c) {
		var l = r.isDark,
			...
			C = l(v, w),
			M = l(a, w);
		m ? u(t, n, o, s, d, h, !y && !M, !y && !A, !k && !A, !k && !M) : f(t, n, o, s, d, h, y && M && T, y && A && E,
			k && A && B, k && M && C)
	}
	...
	function l(r, t, e) {
		...
		if (w(e.fill).is("img")) {
			...
			t.globalCompositeOperation = "destination-out", t.fill(), t.globalCompositeOperation = h, t.clip(), t
			...
			var o = 236,
				...
				m = function(r, t) {
					h = 4 * l + 17, d = function(r) {
							...
							return t
						}(h), T(0, 0), T(h - 7, 0), T(0, h - 7), A(), E(), k(r, t), l >= 7 && B(r), null ==
						v && (v = b(l, s, w)), C(v, t)
				},
				T = function(r, t) {
					for (var e = -1; 7 >= e; e += 1)
						if (!(-1 >= r + e || r + e >= h))
							for (var n = -1; 7 >= n; n += 1) - 1 >= t + n || t + n >= h || (e >= 0 && 6 >=
								e && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) ||
								e >= 2 && 4 >= e && n >= 2 && 4 >= n ? d[r + e][t + n] = !0 : d[r + e][
									t + n
								] = !1)
				},
				y = function() {
							...
							if (null == d[n][o])
								for (var a = -2; 2 >= a; a += 1)
									for (var u = -2; 2 >= u; u += 1) - 2 == a || 2 == a || -2 == u || 2 ==
										u || 0 == a && 0 == u ? d[n + a][o + u] = !0 : d[n + a][o + u] = !1
						}
				},
				B = function(r) {
				...
				k = function(r, t) {
					...
					for (var o = 0; 15 > o; o += 1) {
						var a = !r && 1 == (n >> o & 1);
						8 > o ? d[8][h - o - 1] = a : 9 > o ? d[8][15 - o - 1 + 1] = a : d[8][15 - o - 1] =
							a
					}
					d[h - 8][8] = !r
				},
				C = function(r, t) {
					for (var e = -1, n = h - 1, o = 7, a = 0, u = i.getMaskFunction(t), f = h - 1; f >
						0; f -= 2)
						for (6 == f && (f -= 1);;) {
							for (var c = 0; 2 > c; c += 1)
								if (null == d[n][f - c]) {
				...
				b = function(r, t, e) {
					for (var n = u.getRSBlocks(r, t), c = f(), l = 0; l < e.length; l += 1) {
						var s = e[l];
						c.put(s.getMode(), 4), c.put(s.getLength(), i.getLengthInBits(s.getMode(), r)), s
							.write(c)
					}
					for (var d = 0, l = 0; l < n.length; l += 1) d += n[l].dataCount;
					if (c.getLengthInBits() > 8 * d) throw new Error("code length overflow. (" + c
						.getLengthInBits() + ">" + 8 * d + ")");
					for (c.getLengthInBits() + 4 <= 8 * d && c.put(0, 4); c.getLengthInBits() % 8 != 0;) c
						.putBit(!1);
					for (; !(c.getLengthInBits() >= 8 * d) && (c.put(o, 8), !(c.getLengthInBits() >= 8 *
						d));) c.put(a, 8);
					return M(c, n)
				};
				...
				var a = function(r) {
					...
					u = function(r) {
						...
						for (d += 1; d < o.length;) {
							...
							d += 1, i.contains(h + g) ? h += g : (s.write(i.indexOf(h), n), i.size() < 4095 && (
								i.size() == 1 << n && (n += 1), i.add(h + g)), h = g)
						}
	...
	r.fn.share = function(t, e) {
		function n(t, e) {
			...
			for ($i in n) {
				var o = n[$i],
					u = a(o, e),
					f = e.initialized ? t.find(".icon-" + o) : r('<a href="javascript:;" class="iconfont icon-' +
						o + '" target="_blank"></a>');
		...
		function o(r, t) {
			...
			e.append('<div class="wechat-qrcode"><h4>' + t.wechatQrcodeTitle +
					'</h4><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e
				.find(".qrcode").qrcode({
					size: 100,
					text: t.url
				})
		...
		function i(r, t) {
			return "string" == typeof r && (r = r.split(",")), "string" == typeof t && (t = t.split(",")), r.filter(
				function(r) {
		...
		var u = r(document).find("img:first").prop("src"),
			f = {
				...
				source: r(document.head).find('[name="site"]').attr("content") || r(document.head).find(
					'[name="Site"]').attr("content") || document.title,
				title: r(document.head).find('[name="title"]').attr("content") || r(document.head).find(
					'[name="Title"]').attr("content") || document.title,
				description: r(document.head).find('[name="description"]').attr("content") || r(document.head).find(
					'[name="Description"]').attr("content"),
				image: u ? u : "",
				wechatQrcodeTitle: "微信扫一扫",
				wechatQrcodeHelper: "<p>在微信上打开本网站</p><p>可以收藏或转发</p>",
				sites: [ "qq", "wechat",  "douban", "qzone", "twitter"
				],
				disabled: [],
				initialized: !1
			},
